...
describe('Air Quality Router', () => {
    ...
    describe('GET /', () => {
        it('should return air quality data when valid coordinates are provided', async () => {
            ...
            (AirQualityController.getAirQuality as jest.Mock).mockResolvedValue(mockData);
            ...
            expect(AirQualityController.getAirQuality).toHaveBeenCalledWith(40.7128, -74.0060);
        });
        ...
        it('should return 500 if controller throws an error', async () => {
            (AirQualityController.getAirQuality as jest.Mock).mockRejectedValue(new Error('API error'));
    ...
    describe('GET /all', () => {
        it('should return all air quality records for a specific location', async () => {
            ...
            (AirQualityController.getAllAirQuality as jest.Mock).mockResolvedValue(mockData);
            ...
            expect(response.status).toBe(200);
            expect(response.body).toEqual(mockData);
            expect(AirQualityController.getAllAirQuality).toHaveBeenCalledWith('loc123');
        });
    ...
    describe('POST /', () => {
        it('should add new air quality data successfully', async () => {
            ...
            (AirQualityController.addAirQuality as jest.Mock).mockResolvedValue(mockData);
            ...
            expect(AirQualityController.addAirQuality).toHaveBeenCalledWith(
                'loc123', 40.7128, -74.0060, { aqi: 42 }, '2023-04-01T12:00:00Z'
            );
        });
    });
    ...
    describe('DELETE /', () => {
        it('should delete air quality data successfully', async () => {
            ...
            (AirQualityController.deleteAirQuality as jest.Mock).mockResolvedValue(mockData);
            ...
            expect(response.status).toBe(200);
            expect(response.body).toEqual(mockData);
            expect(AirQualityController.deleteAirQuality).toHaveBeenCalledWith('loc123');
        });
    });
    ...
    describe('GET /MeasurementQuality', () => {
        it('should return measurement quality data when valid coordinates are provided', async () => {
            ...
            (AirQualityController.getMeasurementQuality as jest.Mock).mockResolvedValue(mockData);
            ...
            expect(response.status).toBe(200);
            expect(response.body).toEqual(mockData);
            expect(AirQualityController.getMeasurementQuality).toHaveBeenCalledWith(40.7128, -74.0060);
        });
