...
import { RootState, FireQuestions } from '../../utils/types';
        ...
        <>
            ...
            >
                ...
                <Box width="100%" maxWidth="500px" my={2}>
                    <FormControl>
                        <FormLabel id="fireType-label">Is it a structure fire or wildfire?</FormLabel>
                        <RadioGroup
                            row
                        ...
                        >
                            <FormControlLabel value="structure fire" control={<Radio />} label="Structure fire" />
                ...
                <Box width="100%" maxWidth="500px" my={2}>
                    <FormControl>
                        <FormLabel id="hasHazards-label">Are there any hazardous materials present?</FormLabel>
                        <RadioGroup
                            row
               ...
               <Box sx={{ display: "flex", maxWidth: "500px", width: "100%", alignItems: "start", color: "rgba(0, 0, 0, 0.6)" }}> {/**TODO: Add colors to style guide */}
                    <Typography >What is the number of people within the fire perimeter?</Typography>
                </Box>
