...
const FireForm: React.FC<IProps> = ({ formData, onChange }) => {
        ...
        <>
            ...
            >
                ...
                <Box width="100%" maxWidth="500px" my={2}>
                    <FormControl>
                        <FormLabel id="conscious-label">Is it a structure fire or wildfire?</FormLabel>
                        <RadioGroup
                            row
                        ...
                        >
                            <FormControlLabel value="yes" control={<Radio />} label="Structure Fire" />
                            <FormControlLabel value="no" control={<Radio />} label="Wildfire" />
                        </RadioGroup>
