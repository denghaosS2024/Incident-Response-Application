    ...
    return (
      <Box>
        ...
        <Box sx={{ mb: 3 }}>
          ...
          <RadioGroup value={questions.hasSmoke ? "yes" : "no"} sx={{ ml: 2 }}>
            <FormControlLabel
              value="yes"
              control={<Radio disabled />}
              label="Yes"
        ...
        <Box sx={{ mb: 3 }}>
          ...
          <RadioGroup value={questions.hasFlames ? "yes" : "no"} sx={{ ml: 2 }}>
            <FormControlLabel
              value="yes"
              control={<Radio disabled />}
              label="Yes"
    ...
    return (
      <Box>
        <Box sx={{ mb: 3 }}>
          <FormControlLabel
            control={
              <Checkbox checked={questions.isCallerPatient || false} disabled />
            }
    ...
    return (
      <Box>
        <Box sx={{ mb: 3 }}>
          ...
          <RadioGroup value={questions.isSafe ? "yes" : "no"} sx={{ ml: 2 }}>
            <FormControlLabel
              value="yes"
              control={<Radio disabled />}
              label="Yes"
