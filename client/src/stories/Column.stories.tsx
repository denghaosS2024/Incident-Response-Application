...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: 'The `Column` component represents a draggable column containing tasks or users. It supports drag-and-drop functionality through `react-beautiful-dnd`. You can also associate users with groups and click on a group to perform specific actions.',
      },
    },
  },
