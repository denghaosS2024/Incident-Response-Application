...
export const VideoMessage: Story = {
  args: {
    message: {
      ...
      content:
        "https://storage.googleapis.com/sem-video-bucket/videos/sample-video.webm",
    },
  },
};
...
export const ImageMessage: Story = {
  args: {
    message: {
      ...
      timestamp: "5 minutes ago",
      content:
        "https://storage.googleapis.com/sem-video-bucket/images/sample-image.png",
    },
  },
};
...
export const FileMessage: Story = {
  args: {
    message: {
      ...
      timestamp: "5 minutes ago",
      content:
        "https://storage.googleapis.com/sem-video-bucket/uploads/file.pdf",
    },
  },
};
...
export const AudioMessage: Story = {
  args: {
    message: {
      ...
      timestamp: "5 minutes ago",
      content:
        "https://storage.googleapis.com/sem-video-bucket/voice_messages/sample-voice.webcam",
    },
  },
};
...
export const AcknowledgeAlertVariant: Story = {
  args: {
    message: {
      ...
      acknowledgedAt: ["2024-03-09T10:00:00Z", "2024-03-09T10:05:00Z"],
    },
  ...
  decorators: [
    (Story, context) => {
      ...
      const updatedMessage = JSON.parse(
        JSON.stringify(context.initialArgs.message),
      );
