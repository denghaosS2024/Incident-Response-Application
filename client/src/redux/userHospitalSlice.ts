...
export const { setCurrentHospitalId, clearCurrentHospitalId } =
  userHospitalSlice.actions;

// Selector to get the current hospital ID
export const selectCurrentHospitalId = (state: {
  userHospital: UserHospitalState;
}) => state.userHospital.currentHospitalId;
